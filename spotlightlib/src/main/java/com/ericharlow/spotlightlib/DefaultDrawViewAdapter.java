...
public class DefaultDrawViewAdapter implements DrawViewAdapter {
    ...
    private List< SpotlightPoint > listPoints;
    private int margin;
    private Context context;

    public DefaultDrawViewAdapter( Context context, List< SpotlightPoint > listPoints ) {
        this(context,
    ...
    public DefaultDrawViewAdapter( Context context, Drawable drawable, TextPaint textPaint, List< SpotlightPoint > listPoints ) {
        ...
        this.listPoints = listPoints != null ? listPoints : new ArrayList< SpotlightPoint >(0);
    ...
    public Drawable getDrawableAt( int position ) {
        SpotlightPoint point = getListPoint(position);
    ...
    public void setListPoints(List< SpotlightPoint > listPoints) {
